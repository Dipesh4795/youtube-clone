    ...
    return (
        <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black">
            ...
            <div className="flex h-5 items-center">
                ...
                <Link to="/" className="h-full aspect-auto" >
                    <img
            ...
            <div className="  group flex items-center">
                <div className=" group flex h-8 md:h-10 md:ml-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
                    <div className="w-12 items-center justify-center hidden group-focus-within:md:flex">
                        <IoIosSearch className="text-white text-xl" />
                    </div>
                    <input
                        type="text"
                        className="bg-transparent outline-none text-white pr-5 pl-5 md:pl-0 w-44 md:group-focus-within:pl-3 md:w-64 lg:w-[500px]"
            ...
            <div className="flex items-center">
                ...
                <div className="flex h-8 w-8 rounded-full md:ml-4">
                    <img src="https://xsgames.co/randomusers/assets/avatars/female/67.jpg " className="h-full w-full rounded-full" />
                </div>
            </div>
        </div>
    );
